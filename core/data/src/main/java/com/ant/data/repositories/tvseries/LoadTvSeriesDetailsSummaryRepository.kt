...
) : Repository<RequestType.TvSeriesRequestDetails, TvShowDetails> {
    override suspend fun performRequest(params: RequestType.TvSeriesRequestDetails): TvShowDetails {
